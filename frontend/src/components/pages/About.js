...
function About() {
  ...
  return (
    <div className='about-cover'>
      <hr/>
      <p>
      Our Library Management System is a robust platform that allows users to explore and order books from various categories.
      ...
      <p>
        In order to maintain library_Management_System, we will have the following set of components. These
